...
$campaign_scrape_content_begin_code = stripslashes($campaign_scrape_content_begin_code);
$campaign_scrape_content_end_code = stripslashes($campaign_scrape_content_end_code);
$campaign_scrape_comments_begin_code = stripslashes($campaign_scrape_comments_begin_code);
$campaign_scrape_comments_end_code = stripslashes($campaign_scrape_comments_end_code);
$campaign_scrape_names_begin_code = stripslashes($campaign_scrape_names_begin_code);
$campaign_scrape_names_end_code = stripslashes($campaign_scrape_names_end_code);
...
$(document).ready(function() 
{
	...
	<?php
	if (!$campaign_scrape_content)
	{
	 echo "$('.class_scrape_content').val('0');";
	}
	if (!$campaign_scrape_comments)
	{
	 echo "$('.class_scrape_comments').val('0');";
	}
	?>
	$(".class_scrape_content").change(function(){	   
	   var input =$(this).val();
	   if (input==1)
	   {
			
		   var clone = "<tr class='scrapevar_content'><td align=right  style='font-size:13px;'><i>Begin Code:</i></td><td align=right><textarea rows=1 cols=25 name=rss_scrape_content_begin_code></textarea></td></tr><tr class='scrapevar_content'><td align=right style='font-size:13px;'><i>End Code:</td><td align=right><textarea rows=1 cols=25 name=rss_scrape_content_end_code></textarea></td></tr>";
		   $("#rss_scrape_content").append(clone);
	   }
	   else
	   {
		  $('.scrapevar_content').remove();
	   }
	});
	
	$(".class_scrape_comments").change(function(){	   
	   var input =$(this).val();

	   if (input==1)
	   {
		   var clone = "<tr class='scrapevar_comments'><td align=right style='font-size:13px;'><i>Name Begin Code:</i></td><td align=right><textarea rows=1 cols=25 name=rss_scrape_names_begin_code></textarea></td></tr><tr class='scrapevar_comments'><td align=right style='font-size:13px;'><i>Name End Code:</td><td align=right><textarea rows=1 cols=25 name=rss_scrape_names_end_code></textarea></td></tr><tr class='scrapevar_comments'><td align=right style='font-size:13px;'><i>Comment Begin Code:</i></td><td align=right><textarea rows=1 cols=25 name=rss_scrape_comments_begin_code></textarea></td></tr><tr  class='scrapevar_comments'><td align=right style='font-size:13px;'><i>Comment End Code:</td><td align=right><textarea rows=1 cols=25 name=rss_scrape_comments_end_code></textarea></td></tr><tr class='scrapevar_comments'><td style=\"font-size: 13px;\" align=\"left\" valign=\"top\">&nbsp;&nbsp;&nbsp;<img src=\"./../nav/tip.png\" style=\"cursor: pointer;\" title=\"Will limit the number of sourced comments to publish. Leave at zero to source all possible comments.\" border=\"0\">Limit Comments:<br> </td><td style=\"font-size: 13px;\" align=\"right\"><input name=\"comments_limit\" size=\"1\" value=\"0\">	</td></tr>";
		   $("#rss_scrape_comments").append(clone);
	   }
	   else
	   {
		  $('.scrapevar_comments').remove();
	   }
	});
...
<table width="100%">
	<tr>
		<td width='50%' valign='top'>
			...
			<center>						   
			<div style="font-size:14px;width:500;text-align:left;margin-left:auto;margin-right:auto;font-weight:600;">RSS Campaign Setup
			</div>
			...
			<table width=500 style="margin-left:auto;margin-right:auto;border: solid 1px #eeeeee;"> 
			  ...
			  <tr>
					...
					<td colspan=2>
						...
						?>
							<table id='id_table_datepicker' width='100%'>
								...
								<tr>
									<td  align=left valign=top style='font-size:13px;'>
										&nbsp;&nbsp&nbsp;<img src='./../nav/tip.png' style='cursor:pointer;' border=0 title='If we set this to yes then BlogSense will not skip days in order to catch the scheduling system back up to the current date.(BlogSense typically does this when days have past without any postings). Set to on if you are wanting to start postings from a past date. '>
										&nbsp; Are we backdating?  
									</td>
									<td align=right style='font-size:13px;'>
			   ...
			   <tr>
					...
					<td align=right style="font-size:13px;">
						...
						<?php
						 if ($campaign_post_overwrite==0&&$_GET['edit']==1)
						 {
			  ...
			  <tr>
				...
				<tr>
					 <td colspan=2>
					 <table id="rss_scrape_content" width=100%>
						 <tr>			 
							 <td  align=left valign=top style='font-size:13px;'>
								<img src="./../nav/tip.png" style="cursor:pointer;" border=0 title="Scrape additional rss content from partial rss feeds.  You may use %wildcard% to denote a span of text to ignore.">
								Partial to Full Content:<br> 
							 </td>
							 <td  align=right style='font-size:13px;'>
								 <select name=rss_scrape_content class=class_scrape_content id=id_selects_scrape_content>
									<option value=0 class=scrape_off id=scrape_off <?php if ($campaign_scrape_content==0||!$campaign_scrape_content){ echo "selected=true"; }?>>Off</option>	
									<option value=1  id=scrape_on <?php if ($campaign_scrape_content==1){ echo "selected=true"; }?>>Scrape Content</option>
									<option value=3 class=scrape_fivefilters id=scrape_fivefilters <?php if ($campaign_scrape_content==3){ echo "selected=true"; }?>>Use Fivefilters</option>	
								 </select>	
							</td>
						</tr>
						<?php
						...
						{ 
							echo "<tr class='scrapevar_content'><td align=right style='font-size:13px;'><i>Begin Code:</i></td><td align=right><textarea rows=1 cols=25 name=rss_scrape_content_begin_code>$campaign_scrape_content_begin_code</textarea></td></tr><tr><td align=right style='font-size:13px;'><i>End Code:</td><td align=right><textarea rows=1 cols=25 name=rss_scrape_content_end_code>$campaign_scrape_content_end_code</textarea></td></tr>"; 
						}
						?>
					</table>
					</td>
				...
				<tr>
					 <td colspan=2>
					 <table id="rss_scrape_comments" width=100%>
						 <tr>			 
							 <td  align=left valign=top style='font-size:13px;'>
								<img src="./../nav/tip.png" style="cursor:pointer;" border=0 title="Setup paramaters to scrape the username and the content. You may use %wildcard% to denote a span of text to ignore.">
								Scrape Comments?<br> 
							 </td>
							 <td  align=right style='font-size:13px;'>
								 <select name=rss_scrape_comments class=class_scrape_comments id=id_selects_scrape_comments>
									<option value=0 class=scrape_off id=scrape_off <?php if ($campaign_scrape_comments==0||!$campaign_scrape_comments){ echo "selected=true"; }?>>Off</option>	
									<option value=1  id=scrape_on <?php if ($campaign_scrape_comments==1){ echo "selected=true"; }?>>On</option>
								</select>	
							</td>
						</tr>
						<?php
						...
						{ 
							echo "<tr class='scrapevar_comments'><td align=right style='font-size:13px;'><i>Name Begin Code:</i></td><td align=right><textarea rows=1 cols=25 name=rss_scrape_names_begin_code>$campaign_scrape_names_begin_code</textarea></td></tr><tr class='scrapevar_comments'><td align=right style='font-size:13px;'><i>Name End Code:</td><td align=right><textarea rows=1 cols=25 name=rss_scrape_names_end_code>$campaign_scrape_names_end_code</textarea></td></tr>"; 
							echo "<tr class='scrapevar_comments'><td align=right style='font-size:13px;'><i>Comment Begin Code:</i></td><td align=right><textarea rows=1 cols=25 name=rss_scrape_comments_begin_code>$campaign_scrape_comments_begin_code</textarea></td></tr><tr class='scrapevar_comments'><td align=right style='font-size:13px;'><i>Comment End Code:</td><td align=right><textarea rows=1 cols=25 name=rss_scrape_comments_end_code>$campaign_scrape_comments_end_code</textarea></td></tr>"; 
							?>
							<tr class='scrapevar_comments' >
									<td style="font-size: 13px;" align="left" valign="top">
