  ...
  options = jQuery.extend({
    ...
    dialogImageHtml:  "<body class='wym_dialog wym_dialog_image'"
	       ...
	       + "<div class='row'>"
               ...
               + "<input type='text' class='wym_float' value='right' size='40' />"
               + "</div>"
               + "<div class='row row-indent'>"
               + "<input class='wym_submit' type='button'"
               + " value='{Submit}' />"
...
WYMeditor.INIT_DIALOG = function(index) {
  ...
  if(selected) {
    ...
    jQuery(wym._options.floatSelector).val(jQuery(selected).attr(WYMeditor.FLOAT));
  }
  ...
  if(wym._selected_image) {
    ...
    jQuery(wym._options.dialogImageSelector + " " + wym._options.floatSelector)
      .val(jQuery(wym._selected_image).attr(WYMeditor.FLOAT));
  }
  ...
  jQuery(wym._options.dialogImageSelector + " "
    + wym._options.submitSelector).click(function() {
      ...
      if(sUrl.length > 0) {
	    ...
	    .css(WYMeditor.FLOAT, jQuery(wym._options.floatSelector).val());
      }
      window.close();
  });
